      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-info">
            <li><a href="https://maps.app.goo.gl/H4hTm51cPEYcBf1p7?g_st=iw" target="_blank" rel="noopener noreferrer" aria-label="School Location">📍 Vanasthalipuram, Hyderabad</a></li>
